...
Chapter 1 ワークショップ（Stage 0〜22）の各アウトプットを、AI と一緒に 1 ファイルずつ作っていくテンプレート集。途中で止まっても、ファイルを上から順に進めれば PoC 計画書、ピッチ資料、次フェーズへの引き継ぎセットまで辿り着けるようになっている。
...
| 21 | [stage21_pitch_deck.md](stage21_pitch_deck.md) | ピッチ資料（Slidev）＋発表台本 |
| 22 | [stage22_handoff_package.md](stage22_handoff_package.md) | 次フェーズ引き継ぎセット＋提出パッケージ |
